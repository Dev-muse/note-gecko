        ...
        <div className="flex flex-col max-h-60 gap-1 overflow-y-auto">
          {
            allArticles.map((item,index)=>(
              <div key={`link-${index}`} className="link-card"
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
        {
          ...
          error? (<p className="font-inter font-bold text-center text-black">Well that wasn't supposed to happen... <br />
          <span className="font-satoshi font-normal text-slate-700">
            ...
            article.summary&& (
              <div className="flex flex-col gap-3">
                <h2 className="font-satoshi font-bold text-gray-600 text-xl">Article <span className='green_gradient'>Summary</span></h2>
                <div className="summary_box">
                  <p className="font-inter font-medium text-sm text-slate-700">{article.summary}</p>
                </div>
              </div>
            )
          )
